      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="col-md-12 card mb-4 py-3 border-bottom-warning">
            <form action="<?=base_url()?>index.php/datadasar/updatedata" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" name="luas_lokasi_proklim" class="form-control" required value="<?=$data->luas_lokasi_proklim?>">
            </div>
            <div class="form-group">
              <label class="control-label"> Jumlah Kepala  Keluarga </label>
              <input type="text" class="form-control"  style="background-color: white;" name="jumlah_kepala_keluarga" required value="<?=$data->jumlah_kepala_keluarga?>">
            </div>
            <div class="form-group">
              <label class="control-label"> jumlah penduduk </label>
              <input type="text" class="form-control"  style="background-color: white;" name="jumlah_penduduk" required value="<?=$data->jumlah_penduduk?>">
            </div>
            <div class="form-group">
              <label class="control-label"> Ketinggian Dari Permukaan Laut </label>
              <input type="text" class="form-control"  style="background-color: white;" name="ketinggian_dari_permukaan_laut" required value="<?=$data->ketinggian_dari_permukaan_laut?>">
            </div>
            <div class="form-group">
              <label class="control-label"> Topografi Daerah : </label>
                <input type="checkbox" id="topografi_daerah" name="topografi_daerah" value="Dataran Rendah < 400 mdpl" value="<?=$data->topografi_daerah?>">
                <label for="vehicle1">Dataran Rendah < 400 mdpl</label>

                <input type="checkbox" id="topografi_daerah" name="topografi_daerah" value="Dataran Rendah 400-700 mdpl" value="<?=$data->topografi_daerah?>">
                <label for="vehicle1">Dataran Rendah 400-700 mdpl</label>

                <input type="checkbox" id="topografi_daerah" name="topografi_daerah" value="Dataran Rendah 400-700 mdpl" value="<?=$data->topografi_daerah?>">
                <label for="vehicle1">Dataran Rendah >700 mdpl</label><br>

            </div>

            <div class="form-group">
              <label class="control-label"> Tipologi Lokasi : </label>
                <input type="checkbox" id="tipologi_lokasi" name="tipologi_lokasi" value="Pesisir" value="<?=$data->tipologi_lokasi?>">
                <label for="vehicle1">Pesisir</label>

                <input type="checkbox" id="tipologi_lokasi" name="tipologi_lokasi" value="Perkotaan" value="<?=$data->tipologi_lokasi?>">
                <label for="vehicle1">Perkotaan</label>

                <input type="checkbox" id="tipologi_lokasi" name="tipologi_lokasi" value="Perdesaan" value="<?=$data->tipologi_lokasi?>">
                <label for="vehicle1">Perdesaan</label><br>


                <input type="checkbox" id="tipologi_lokasi" name="tipologi_lokasi" value="Tepi Hutan" value="<?=$data->tipologi_lokasi?>">
                <label for="vehicle1">Tepi Hutan</label><br>

            </div>
            
            <div class="form-group">
              <label class="control-label"> Tujuan Umum </label>
              <input type="text" class="form-control"  style="background-color: white;" name="tujuan_umum" required value="<?=$data->tujuan_umum?>">
            </div>
            <div class="form-group">
              <label class="control-label"> Tujuan Khusus </label>
              <input type="text" class="form-control"  style="background-color: white;" name="tujuan_khusus" required value="<?=$data->tujuan_khusus?>">
            </div>
            <hr>   
            <div class="row">
