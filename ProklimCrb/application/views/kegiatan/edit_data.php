      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="col-md-12 card mb-4 py-3 border-bottom-warning">
            <form action="<?=base_url()?>index.php/Kegiatan/updatedata" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="date" class="form-control"  style="background-color: white;" name="tanggal" required value="<?=$data->tanggal?>">
            </div>
            <div class="form-group">
              <label class="control-label"> Durasi </label>
              <input type="text" class="form-control"  style="background-color: white;" name="durasi" required value="<?=$data->durasi?>">
            </div>
            <div class="form-group">
              <label class="control-label"> Jenis Kegiatan : </label>
                <input type="checkbox" id="aksi" name="jenis_kegiatan" value="Aksi" value="<?=$data->jenis_kegiatan?>">
                <label for="vehicle1">Aksi</label>

                <input type="checkbox" id="Sumberdaya" name="jenis_kegiatan" value="sumberdaya" value="<?=$data->jenis_kegiatan?>">
