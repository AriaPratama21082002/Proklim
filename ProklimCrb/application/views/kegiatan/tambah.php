            ...
            <div class="col-md-12 card mb-4 py-3 border-bottom-warning">
              <form action="<?=base_url()?>index.php/Kegiatan/insertdata" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="date" class="form-control"  style="background-color: white;" name="tanggal" >
                </div>
                <div class="form-group">
                  <label class="control-label"> Durasi </label>
                  <input type="text" class="form-control"  style="background-color: white;" name="durasi" >
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control"  style="background-color: white;" name="tujuan_umum" >
                </div>
                <div class="form-group">
                  <label class="control-label"> Tujuan Khusus </label>
                  <input type="text" class="form-control"  style="background-color: white;" name="tujuan_khusus" >
                </div>
                <hr>
                ...
                <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="keterkaitan_program" >
                ...
                <div class="col-lg-6">
                 ...
                 <div class="form-group">
                  ...
                  <select class="form-control" name="alih_tekhnologi" >
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="peningkatan_kapasitas" >
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="status_pendanaan" >
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="tenaga_ahli" >
            ...
            <div class="row">
              <div class="col-md-12 card mb-4 py-3 border-bottom-warning">
                <div class="form-group">
                  ...
                  <input type="text" name="luas_lokasi_proklim" class="form-control" >
                </div>
                <div class="form-group">
                  <label class="control-label"> Jumlah Kepala Keluarga </label>
                  <input type="text" class="form-control"  style="background-color: white;" name="jumlah_kepala_keluarga" >
                </div>
                <div class="form-group">
                  <label class="control-label"> Jumlah Penduduk </label>
                  <input type="text" class="form-control"  style="background-color: white;" name="jumlah_penduduk" >
                </div>
                <div class="form-group">
                  <label class="control-label"> Ketinggian dari permukaan laut </label>
                  <input type="text" class="form-control"  style="background-color: white;" name="ketinggian_dari_permukaan_laut" >
                </div>
                <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <select id="tipologi_lokasi" name="tipologi_lokasi">
                        ...
                        <label class="control-label"> -----> Apa bila tidak ada Option di atas isi di bawah ini <------</label>
                          <input type="text" class="form-control"  style="background-color: white;" name="tipologi_lokasi" >
                        </div>
                        <div class="form-group">
                          ...
                          <select id="ciri_khas_lokasi" name="ciri_khas_lokasi">
                            ...
                            <br>
                            <label class="control-label"> -----> Apa bila tidak ada Option di atas isi di bawah ini <------</label>
                              <input type="text" class="form-control"  style="background-color: white;" name="ciri_khas_lokasi" >
                            </div>
                            <hr>
                            ...
                            <div class="row">
                              <div class="col-lg-6">
                               ...
                               <div class="form-group">
                                ...
                                <select class="form-control" name="tiga_penggunaan_lahan" >
                              ...
                              <label class="control-label"> -----> Persentase <------</label>
                                <div class="input-group-append">
                                  <input type="text" class="form-control"  style="background-color: white;" name="persentase" >
                                  <span class="input-group-text">%</span>
                                </div>
                                <br>
                                <div class="form-group">
                                  <label class="control-label">b. Jenis Lahan  </label>
                                  <select class="form-control" name="tiga_penggunaan_lahan1" >
                                    <option selected>---Pilih Jenis Lahan---</option>
                                    <option value="pertanian">Pertanian</option>
                                    <option value="perkebunan">Perkebunan</option>
                                    <option value="hutan">Hutan</option>
                                  ...
                                  <label class="control-label"> -----> Persentase <------</label>
                                    <div class="input-group-append">
                                      <input type="text" class="form-control"  style="background-color: white;" name="persentase1" >
                                      <span class="input-group-text">%</span>
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <label class="control-label">c. Jenis Lahan </label>
                                    <select class="form-control" name="tiga_penggunaan_lahan2" >
                                      <option selected>---Pilih Jenis Lahan---</option>
                                      <option value="pertanian">Pertanian</option>
                                      <option value="perkebunan">Perkebunan</option>
                                      <option value="hutan">Hutan</option>
                                    ...
                                    <label class="control-label"> -----> Persentase <------</label>
                                      <div class="input-group-append">
                                        <input type="text" class="form-control"  style="background-color: white;" name="persentase2" >
                                        <span class="input-group-text">%</span>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <select class="form-control" name="tiga_sumber_penghasilan_utama" >
                                      ...
                                      <label class="control-label"> -----> Persentase <------</label>
                                        <div class="input-group-append">
                                          <input type="text" class="form-control"  style="background-color: white;" name="persentase3" >
                                          <span class="input-group-text">%</span>
                                        </div>
                                      </div>
                                      <div class="form-group">
                                        <label class="control-label"> b. Sumber Penghasilan Utama </label>
                                        <select class="form-control" name="tiga_sumber_penghasilan_utama1" >
                                          <option selected>---Pilih Jenis Sumber Penghasilan utama---</option>
                                          <option value="Perikanan">Perikanan</option>
                                          <option value="Peternakan">Peternakan</option>
                                          <option value="Kehutanan">Kehutanan</option>
                                        ...
                                        <label class="control-label"> -----> Persentase <------</label>
                                          <div class="input-group-append">
                                            <input type="text" class="form-control"  style="background-color: white;" name="persentase4" >
                                            <span class="input-group-text">%</span>
                                          </div>
                                        </div>
                                        <div class="form-group">
                                          <label class="control-label"> c. Sumber Penghasilan Utama</label>
                                          <select class="form-control" name="tiga_sumber_penghasilan_utama2" >
                                            <option selected>---Pilih Jenis Sumber Penghasilan utama---</option>
                                            <option value="Perikanan">Perikanan</option>
                                            <option value="Peternakan">Peternakan</option>
                                            <option value="Kehutanan">Kehutanan</option>
                                          ...
                                          <label class="control-label"> -----> Persentase <------</label>
                                            <div class="input-group-append">
                                              <input type="text" class="form-control"  style="background-color: white;" name="persentase5" >
                                              <span class="input-group-text">%</span>
                                            </div>
                                          </div>
                                        </div>
                                      ...
                                      <div class="row">
                                        <div class="col-md-12 card mb-4 py-3">
                                          <div class="form-group">
                                          ...
                                          <div class="form-group">
                                              ...
                                              <input type="text" class="form-control"  style="background-color: white;" name="satuan" >
                                            </div>
                                            <div class="form-group">
                                              <label class="control-label"> Jumlah </label>
                                              <input type="text" class="form-control"  style="background-color: white;" name="jumlah" >
                                            </div>
