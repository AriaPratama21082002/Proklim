...
class Auth extends CI_Controller
{
	...
	public function register()
    {
        ...
        $this->form_validation->set_rules('jalan_nomor_rt_rw', 'jalan_nomor_rt_rw', 'required|trim');
        $this->form_validation->set_rules('desa_kelurahan', 'desa_kelurahan', 'required|trim');
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data = [
                ...
                'jalan_nomor_rt_rw' => htmlspecialchars($this->input->post('jalan_nomor_rt_rw', true)),
                'desa_kelurahan' => htmlspecialchars($this->input->post('desa_kelurahan', true)),
                'kecamatan' => htmlspecialchars($this->input->post('kecamatan', true)),
                'kota_kabupaten' => htmlspecialchars($this->input->post('kota_kabupaten', true)),
                'provinsi' => htmlspecialchars($this->input->post('provinsi', true)),
                'no_telpn' => htmlspecialchars($this->input->post('no_telpn', true)),
